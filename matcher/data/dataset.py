...
class FSSDataset:
    ...
    def build_dataloader(cls, benchmark, bsz, nworker, fold, split, shot=1):
        ...
        dataset = cls.datasets[benchmark](cls.datapath, fold=fold, transform=cls.transform, split=split, shot=shot, use_original_imgsize=cls.use_original_imgsize, supp_class_ids=SUPP_CLASS_IDS[benchmark][fold])
